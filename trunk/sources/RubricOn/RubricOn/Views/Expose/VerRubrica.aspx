<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/ExposeSite.Master" Inherits="System.Web.Mvc.ViewPage<RubricOn.ViewModel.VerRubricaExposeViewModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% if(Model.RutaRetorno!="") {%>
        <%= Html.Link("Regresar",Model.RutaRetorno,null) %>
    <%}%>
