<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ePortafolioMVC.ViewModels.StudentAssignmentListViewModel>" %>
        ...
        <% foreach (BETrabajo Trabajo in Model.Trabajos)
           {
               ...
               String Nota = Grupo != null ? Grupo.Nota : "NE";
               if (Nota == "NE" || Nota == "IN")
                   Nota = "-";
            %>
