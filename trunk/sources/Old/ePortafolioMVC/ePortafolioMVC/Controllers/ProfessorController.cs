...
namespace ePortafolioMVC.Controllers
{
    public class ProfessorController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            List<BECurso> Cursos = RepositoryFactory.GetCursoRepository().GetCursosDictados(Profesor.ProfesorId, PeriodoVista.PeriodoId);
        ...
        {
            ProfessorGradeAssignmentViewModel ProfessorGradeAssignment = new ProfessorGradeAssignmentViewModel();
        ...
        public ActionResult Grades(int TrabajoId, String Origen)
        {
            ...
            foreach (BESeccion Seccion in SeccionesDictado)
            {
                ...
                foreach (BEGrupo Grupo in GruposEntregados)
                {
                    ...
                    {
                        ProfessorGradesViewModel.AlumnosGrupos.Add(Alumno, Grupo);
                    }
                }
                ...
                foreach (BEAlumno Alumno in AlumnosSinGrupo)
                {
                    ProfessorGradesViewModel.AlumnosGrupos.Add(Alumno, new BEGrupo{Nota = "NE",Seccion = Seccion});
                }
            }
            ...
            ProfessorGradesViewModel.AlumnosGrupos = ProfessorGradesViewModel.AlumnosGrupos.OrderBy(x=>x.Key.Nombre).ToDictionary(x=>x.Key,x=>x.Value);
